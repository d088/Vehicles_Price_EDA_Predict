...
#df.rename({'Odometer': 'Mileage', 'Sell_price': 'Price'}, inplace=True)
df.rename(columns={'Odometer': 'Mileage', 'Sell_price': 'Price'}, inplace=True)
...
if filtered_df.empty:
    ...
    condition_price_count_df = filtered_df.groupby('Condition').agg(Average_Price=('Price', 'mean'), Count=('Condition', 'size')).reset_index()
